...
<div>
    ...
    <div class="relative">
        ...
        >
            ...
            <option value="TTD" {{ old('currency') == 'TTD' ? 'selected' : '' }}>
            ...
            <option value="RUB" {{ old('currency') == 'RUB' ? 'selected' : '' }}>
                RUB - Russian Ruble
            </option>

            <option value="MXN" {{ old('currency') == 'MXN' ? 'selected' : '' }}>
                MXN - Mexican Peso
            </option>
            ...
            <option value="PHP" {{ old('currency') == 'PHP' ? 'selected' : '' }}>
                PHP - Philippine Peso
            </option>
        </select>
